        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (userAccount !== null) {
                    ...
                    return [2 /*return*/, this.msalInstance.acquireTokenSilent(accessTokenRequest).then(function (response) {
                            return response;
    ...
    MSALWrapper.prototype.acquireAccessToken = function (scopes, userEmail) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.msalInstance.ssoSilent(accessTokenRequest).then(function (response) {
                        return response;
                    }).catch(function (silentError) {
                        console.log(silentError);
                        if (silentError instanceof InteractionRequiredAuthError) {
                            return _this.msalInstance.loginPopup(accessTokenRequest).then(function (response) {
                                return response;
