...
echo "=== Next Steps ==="
echo ""
echo "The Apex classes and Remote Site Setting have been deployed."
echo "You must now manually configure the Named Credential in Salesforce Setup."
echo ""
echo "Follow the instructions in the Microsoft Learn documentation:"
